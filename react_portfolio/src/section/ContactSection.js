                ...
                <form className="contact-form">
                    <div className="contact-form-top-wrapper">
                        ...
                        <div className="contact-form-mail-wrap">
                            <label>Mail</label>
                            <input type="email" name="contact-form-input-mail" className="contact-form-input contact-form-mail"></input>
                        </div>
                        <div className="contact-form-phone-wrap">
                            <label>Téléphone</label>
                            <input type="tel" name="contact-form-input-phone" className="contact-form-input contact-form-phone"></input>
                        </div>
                    </div>
                    <div className="contact-form-bottom-wrapper">
                        <label>Message</label>
                        <textarea type="text" name="contact-form-message" className="contact-form-input-message"></textarea>
                    </div>
